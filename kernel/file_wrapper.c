...
static int ksu_wrapper_iopoll(struct kiocb *kiocb, bool spin)
{
    ...
    defined(KSU_COMPAT_HAS_FOPS_ITERATE)
static int ksu_wrapper_iterate(struct file *fp, struct dir_context *dc)
{
    ...
    defined(KSU_COMPAT_HAS_FOPS_ITERATE_SHARED)
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(6, 6, 0) ||                            \
    defined(KSU_COMPAT_HAS_FOPS_SENDPAGE)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 6, 0) ||                           \
    defined(KSU_COMPAT_HAS_FOPS_SPLICE_EOF)
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 7, 0) ||                           \
    defined(KSU_COMPAT_HAS_FOPS_COPY_FILE_RANGE)
                                           ...
                                           unsigned int flags)
{
    ...
    defined(KSU_COMPAT_HAS_FOPS_REMAP_FILE_RANGE)
                                           ...
                                           unsigned int remap_flags)
{
    ...
    defined(KSU_COMPAT_HAS_FOPS_FADVISE)
