...
$(eval $(call check_ksu_manual_guard,$(srctree)/fs/exec.c,failed to grant to root or module not working))
...
$(eval $(call check_ksu_manual_guard,$(srctree)/kernel/reboot.c,module not working))
