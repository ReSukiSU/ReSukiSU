package com.resukisu.resukisu.ui.screen.module
...
fun createModuleShortcut(
    ...
    when (type) {
        ShortcutType.Action -> Shortcut.createModuleActionShortcut(
            context = context, moduleId = moduleId, name = name, iconUri = iconUri
        )
