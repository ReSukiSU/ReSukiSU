...
[![Latest build-manager.yml nightly.link](https://img.shields.io/badge/nightly.link-latest%20build--manager.yml-800080)](https://nightly.link/ReSukiSU/ReSukiSU/workflows/build-manager/main)
